...
const PROVIDERS = {
  ...
  minimax: {
    ...
    models: [
      { id: 'MiniMax-M2.7',           label: 'MiniMax M2.7（最新，自我迭代）',        tools: true,  thinking: false, vision: true },
      { id: 'MiniMax-M2.7-highspeed', label: 'MiniMax M2.7 极速版（100tps）',        tools: true,  thinking: false, vision: true },
      { id: 'MiniMax-M2.5',           label: 'MiniMax M2.5（顶尖性能）',             tools: true,  thinking: false, vision: true },
      { id: 'MiniMax-M2.5-highspeed', label: 'MiniMax M2.5 极速版（100tps）',        tools: true,  thinking: false, vision: true },
