...
const PROVIDERS = {
  ...
  google: {
    ...
    models: [
      ...
      { id: 'google/gemini-1.5-pro',             label: 'Gemini 1.5 Pro（百万上下文）', tools: true,  thinking: false },
      { id: 'google/gemini-1.5-flash',           label: 'Gemini 1.5 Flash（性价比）', tools: true,  thinking: false },
