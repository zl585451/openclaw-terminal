...
import { ScriptCharacterBar } from './ScriptCharacterBar';
import { ScriptContent } from './ScriptContent';
import { ScriptPolishPanel } from './ScriptPolishPanel';
import { ScriptRoleDetectPanel } from './ScriptRoleDetectPanel';
...
export default function ScriptViewer({ document }: { document: WorkbenchDocument }) {
