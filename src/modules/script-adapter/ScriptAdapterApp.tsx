...
import { TaskCreateWizardFooter } from './ui/TaskCreateWizardFooter';
import { TaskCreateWizardSidebar } from './ui/TaskCreateWizardSidebar';
import {
  getChapterText,
  ...
  return (
    <div className={styles.createShell}>
      ...
      <main className={styles.composerGrid}>
        <TaskCreateWizardSidebar
          progressValue={progressValue}
          analysisCompleted={analysisCompleted}
          isAnalysisRunning={isAnalysisRunning}
          sourceConfirmed={sourceConfirmed}
          isIntakeRunning={isIntakeRunning}
          intakeStepIndex={intakeStepIndex}
          intakeStepCount={displayedIntakeSteps.length}
          createSteps={createSteps}
          canOpenStep={(step) => canOpenStep(step as WizardStep)}
          openStep={(step) => openStep(step as WizardStep)}
        />
      ...
      <TaskCreateWizardFooter
        policy={footerPolicy}
        onBack={onBack}
        onPrimaryAction={handleFooterAction}
      />
    </div>
  );
}
