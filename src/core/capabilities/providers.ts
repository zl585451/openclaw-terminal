...
export const PROVIDERS: ProviderDefinition[] = [
  ...
  { id: 'openai', displayName: 'OpenAI', capabilities: ['chat', 'chat_vision', 'image_gen', 'tool_exec', 'tts', 'asr'], keyPattern: /^sk-[A-Za-z0-9_-]{20,}$/ },
  { id: 'minimax', displayName: 'MiniMax', capabilities: ['chat', 'chat_vision', 'image_gen', 'tts'], keyPattern: /^eyJ[A-Za-z0-9_-]+\./ },
