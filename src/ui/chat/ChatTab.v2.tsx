...
import type { CapabilityId } from '../../core/capabilities/types';
...
import { CapabilityBar } from '../onboarding/capabilityBar/CapabilityBar';
import { CapabilitySetupDrawer } from '../onboarding/CapabilitySetupDrawer';
import { ChatHeaderPortal } from './ChatHeaderPortal';
...
import type { ChatMessage, ChatTabProps } from './chatTypes';
    ...
    >
      <div className={`chat-section ${files.isDragging ? 'drag-over' : ''}`} style={{ position: 'relative' }}>
        ...
        <ScrollToBottomButton
          ...
          onClick={() => scroll.scheduleScrollAfterLayout(true)}
        />
        {!inquiry.hasActive && (
          <CapabilityBar
